...
*/
  ...
  initPanel: function(instruments){
    ...
    var slide = this, instrument, instrumentSpan, panelContainer = $(slide.options.panelId), bootCol = 12, bootOffset=0, 
        instIds = slide.options.instrumentIds, instrumentObject = {}, options = {}, i=0, numberOfInstrments = 0, instBootCol=12, instrumentOptions = {};
	console.log("these are slide options");
	...
	if (slide.options.panelOverlay){
      		options = {
        	size: 200,
		//these need to be when the panel is inited
		beacononeshow: true,
		beacontwoshow: true,
        	ils: true,
		//
